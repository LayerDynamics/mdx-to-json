...
const App: React.FC = () => {
    ...
    return (
        <Container>
            ...
            <Button onClick={handleCombine} disabled={jsonEntries.length === 0}>Combine Files</Button>
            <FormatButton jsonEntries={jsonEntries} onFormat={handleFormat} />
            <Button onClick={handleSave} disabled={!combinedJson && jsonEntries.length === 0}>Save JSON</Button>
