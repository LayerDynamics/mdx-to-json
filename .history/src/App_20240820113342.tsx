...
const App: React.FC = () => {
    ...
    const { parsedContent, parseMDX } = useParseMDX();  // Using the useParseMDX hook
    ...
    const handlePreview = async () => {
        ...
        for (const file of mdxFiles) {
            try {
                ...
                parseMDX(sanitizedContent);  // Using the parseMDX function from the hook

                // Since parseMDX is asynchronous, wait until it's done processing
                const parsed = parsedContent;
                console.log("Parsed MDX:", parsed); // Debugging log
                if (parsed) {
    ...
    }, [mdxFiles, parsedContent]);  // Adding parsedContent to the dependencies
