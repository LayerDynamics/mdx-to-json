...
import remarkMdx from 'remark-mdx'; // Import remark-mdx for MDX parsing
import rehypeStringify from 'rehype-stringify'; // Import rehype-stringify for stringifying HTML
