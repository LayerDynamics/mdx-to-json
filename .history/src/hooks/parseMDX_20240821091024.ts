...
const visit2 = (node: any): void => {
    ...
    if (Array.isArray(node.children)) {
        ...
        // This is not an error, leaf nodes might not have children
...
// Updated parseMDX function with additional error handling
        ...
        (content: string) => {
            try {
                ...
                const processor = unified()
                    ...
                    .use(rehypeSanitize)
                    .use(() => (tree) => {
                        console.log("Tree before nodeMapper:", JSON.stringify(tree, null, 2));
                        nodeMapper(tree);
                        console.log("Tree after nodeMapper:", JSON.stringify(tree, null, 2));
                        return tree;
                    })
                    .use(rehypeStringify);
