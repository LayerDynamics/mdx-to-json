    ...
    const processFiles = useCallback(async () => {
        ...
        for (const file of mdxFiles) {
            try {
                ...
                const parsedContent = await new Promise<{ content: string; metadata: any } | null>((resolve) => {
                    parseContentBasedOnSyntax(sanitizedContent, (cleanedContent) => {
                        parseMDX(cleanedContent);
                        resolve({ content: cleanedContent, metadata: {} }); // Simplified for this example
                    });
                });
